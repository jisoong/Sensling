function scent() {
    ...
    Eucalyptus = [
      ...
      "유칼립투스 Eucalyptus",
      "유칼립투스는",
      "시원하게 톡 쏘는 향기를 가지고 있으며,",
      "강한 향균력이 있기 때문에 감기예방에도 좋고,",
      "꽃가루에 의한 코막힘에도 효과가 있습니다.",
      " ",
      " ",
      "또한 집중력 향상에도 좋으며",
      "마음의 혼란을 진정시키고 피로 회복에도 좋습니다.",
    ]
    Rosemary = [
      "rosemary",
      "로즈마리 Rosemary",
      "로즈마리는",
      "청량하고 신선한 향기를 가지고 있으며,",
      "집중력과 기억력 향상에 좋습니다.",
      " ",
      " ",
      "일이나 공부할 때,",
